...
const VoluntaryContributions = () => {
  const { title, description, features, benefits } = pensionPageData[1];
    ...
    <section className="w-full">
      <div className="relative h-64 md:h-[443px] flex flex-col items-center justify-center p-8 gap-12.5 sm:p-25 bg-[url('/images/vc-bg.jpg')] bg-cover bg-center overflow-hidden">
        ...
        <div className="absolute z-10 flex flex-col items-center gap-7.5 text-center p-8">
          ...
          <p className="text-base md:text-lg font-medium text-white text-center">Enhance your retirement savings with additional voluntary contributions for a <br /> more comfortable future.</p>
        </div>
      </div>
