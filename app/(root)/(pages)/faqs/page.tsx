    ...
    <section className="w-full">
      <div className="relative h-[50vh] md:h-[443px] flex flex-col items-center justify-center p-8 gap-12.5 sm:p-25 bg-[url('/images/hand-shake-bg.jpg')] bg-cover bg-center overflow-hidden">
        ...
        <div className="absolute z-10 flex flex-col items-center gap-7.5 text-center p-8">
          <h1 className="text-3xl md:text-5xl font-bold text-white">Got Questions? We're Here to Help</h1>
          <p className="text-base md:text-lg font-medium text-white text-center">Find quick answers to the most commonly asked questions about our pension services and benefits.</p>
        </div>
      </div>
