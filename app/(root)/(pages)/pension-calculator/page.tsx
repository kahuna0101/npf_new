...
const PensionCalculator = () => {
  return (
    <section className="w-full">
      <div className="relative h-64 md:h-[443px] flex flex-col items-center justify-center p-8 gap-12.5 sm:p-25 bg-[url('/images/calculator-bg.jpg')] bg-cover bg-center overflow-hidden">
