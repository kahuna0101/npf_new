...
import PensionFeatures from '@/components/PensionFeatures';
import { howItWorksData, pensionPageData } from '@/data';
import Image from 'next/image';

const MortgageEquityContribution = () => {
  const { title, description, features, benefits } = pensionPageData[2];
    ...
    <section className="w-full">
      <div className="relative h-[50vh] md:h-[443px] flex flex-col items-center justify-center p-8 gap-12.5 sm:p-25 bg-[url('/images/mortgage-bg.jpg')] bg-cover bg-center overflow-hidden">
        ...
        <div className="absolute z-10 flex flex-col items-center gap-7.5 text-center p-8">
          ...
          <p className="text-base md:text-lg font-medium text-white text-center">Use a portion of your RSA balance to secure your dream home while <br/> maintaining your retirement savings.</p>
        </div>
      </div>
...
export default MortgageEquityContribution